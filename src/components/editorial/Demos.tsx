    ...
    return (
        <div
            ...
            style={{
                ...
                background:
                    'linear-gradient(135deg, rgba(179,74,31,0.04), transparent 60%)',
            }}
        >
            <div className="flex justify-between items-baseline font-mono text-[10px] tracking-[0.18em] uppercase text-muted mb-3 gap-3 flex-wrap">
                ...
                <span style={{ color: '#3a8c4f' }}>&#9679; API online</span>
            </div>
            ...
            <p className="mt-3 text-muted text-[0.95rem] leading-[1.55] max-w-[480px]">
            ...
            <div
                className="mt-6 h-[200px] flex items-center justify-center relative max-sm:h-[150px]"
                style={{
                    border: '1px solid var(--color-rule)',
            ...
            >
                ...
                />
                <div
                    className="absolute bottom-3 right-3.5 font-mono text-[11px]"
                    style={{
                        color: '#3a8c4f',
...
export function Demos() {
    return (
        <section
            id="demos"
            className="px-8 py-20 border-t border-rule-strong relative max-md:px-5 max-md:py-12 max-sm:px-4 max-sm:py-10"
        >
            <div className="flex justify-between items-baseline mb-8 gap-6 max-md:flex-col max-md:items-start max-md:gap-3">
                <div>
                    <div className="font-mono text-[11px] tracking-[0.22em] uppercase text-muted mb-2">
                        &sect; 03 &mdash; Live, in the browser
                    </div>
                ...
                <div className="font-mono text-[11px] tracking-[0.18em] uppercase text-muted flex items-center gap-2.5 whitespace-nowrap">
                    <span
