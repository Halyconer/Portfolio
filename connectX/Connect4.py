...
class Connect4:
    ...
    def is_valid(self, col):
        self.valid_cols = [
            c for c in range(self.COL_COUNT) if self.board[self.ROW_COUNT - 1][c] == 0
        ]  # Changed this implemntation to dynamically update alongside the AI
        return (
            col in self.valid_cols
        )  # Will return True if the column is valid, otherwise False
    ...
    def play(self):
        while not self.game_over:
            ...
            # AI decision making
                ...
                col = minimax(self.board, 4, True)[
                    0
                ]  # AI selects a column using minimax algorithm
                ...
                if self.is_valid(col):
                    ...
                    valid_cols = [
                        c for c in range(self.COL_COUNT) if self.is_valid(c)
